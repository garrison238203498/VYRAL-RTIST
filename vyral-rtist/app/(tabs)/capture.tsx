    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#000" }} edges={["top"]}>
      ...
      >
        <LinearGradient colors={["#0a0418", "#1e1340", "#0a0418"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={{ flex: 1, position: "relative" }}>
          <View style={{ position: "absolute", inset: 24, borderLeftWidth: 1, borderRightWidth: 1, borderColor: "rgba(255,255,255,0.05)" }} />
          <View style={{ position: "absolute", left: 24, right: 24, top: "33%", borderTopWidth: 1, borderColor: "rgba(255,255,255,0.05)" }} />
          <View style={{ position: "absolute", left: 24, right: 24, top: "66%", borderTopWidth: 1, borderColor: "rgba(255,255,255,0.05)" }} />
...
function RecordButton({ isRecording, onPress, accent }: { isRecording: boolean; onPress: () => void; accent: string }) {
  ...
  const innerColor = useSharedValue(0);
  ...
  }, [isRecording, innerRadius, innerSize, innerColor]);
