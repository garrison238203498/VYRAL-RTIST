// Vyral Capture: viewfinder shell for video/photo/text/voice creation.
// Recording wiring comes in a follow-up — this is the UI surface.
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#000" }} edges={["top"]}>
      ...
      >
        {(["video", "photo", "text", "voice"] as Mode[]).map((m) => (
          <PressableScale
            ...
            onPress={() => setMode(m)}
            style={{
              paddingHorizontal: mode === m ? 16 : 6,
              paddingVertical: mode === m ? 7 : 6,
              borderRadius: 20,
              backgroundColor: mode === m ? "rgba(168,85,247,0.18)" : "transparent",
      ...
      >
        <SideControl
          ...
          icon={
            <Svg width={22} height={22} viewBox="0 0 24 24" fill="none">
              <Path
                d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5L12 3zM19 14l.8 2.2L22 17l-2.2.8L19 20l-.8-2.2L16 17l2.2-.8L19 14z"
                fill="#fff"
              />
            </Svg>
          }
        ...
        <SideControl
          ...
          icon={
            <Svg width={22} height={22} viewBox="0 0 24 24" fill="none">
              <Path
                d="M4 8a4 4 0 014-4h8M20 16a4 4 0 01-4 4H8"
                stroke="#fff"
                strokeWidth={1.8}
                strokeLinecap="round"
              />
              <Path d="M14 2l2 2-2 2M10 22l-2-2 2-2" stroke="#fff" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
            </Svg>
          }
        />
      </Animated.View>
      ...
      >
        <BottomControl
          ...
          icon={
            <Svg width={20} height={20} viewBox="0 0 24 24" fill="none">
              <Path d="M9 18V6l10-2v12" stroke="rgba(255,255,255,0.85)" strokeWidth={1.8} strokeLinejoin="round" />
              <Circle cx={7} cy={18} r={2.4} stroke="rgba(255,255,255,0.85)" strokeWidth={1.8} />
              <Circle cx={17} cy={16} r={2.4} stroke="rgba(255,255,255,0.85)" strokeWidth={1.8} />
            </Svg>
          }
        />
        <BottomControl
          ...
          icon={
            <Svg width={20} height={20} viewBox="0 0 24 24" fill="none">
              <Path
                ...
                strokeLinecap="round"
              />
              <Path d="M12 14l4-4" stroke="rgba(255,255,255,0.85)" strokeWidth={1.8} strokeLinecap="round" />
              <Circle cx={12} cy={14} r={1.4} fill="rgba(255,255,255,0.85)" />
            </Svg>
          }
        />
        <BottomControl
          ...
          icon={
            <Svg width={20} height={20} viewBox="0 0 24 24" fill="none">
              <Circle cx={12} cy={13} r={7} stroke="rgba(255,255,255,0.85)" strokeWidth={1.8} />
              <Path d="M12 9v4l3 2M9 3h6" stroke="rgba(255,255,255,0.85)" strokeWidth={1.8} strokeLinecap="round" />
            </Svg>
          }
        />
        <BottomControl
