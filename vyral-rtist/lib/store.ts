...
// Lightweight per-key JSON store on top of AsyncStorage.
// Used for: approved spaces, themes, recent intakes, navigation pattern,
// affinity-profile cache. Same shape as the old localStorage version.
